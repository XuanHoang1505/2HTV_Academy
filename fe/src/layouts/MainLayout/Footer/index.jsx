    ...
    <footer className="bg-white text-gray-700">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* Contact */}
          <div>
            <h3 className="font-bold text-primary text-lg mb-4">Liên hệ</h3>
            <ul className="space-y-3 text-primary">
              <li className="flex items-start space-x-2">
                <LocationOnIcon className="text-sm mt-1" />
          ...
          <div>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                  <defs>
                    ...
                    >
                      ...
                      <stop offset="25%" stopColor="#e6683c" stopOpacity="1" />
                      <stop offset="50%" stopColor="#dc2743" stopOpacity="1" />
                      <stop offset="75%" stopColor="#cc2366" stopOpacity="1" />
                      <stop offset="100%" stopColor="#bc1888" stopOpacity="1" />
                    </linearGradient>
                  </defs>
                  <path
            ...
            <div className="mt-6">
              <Button
                type="primary"
                size="large"
                className="custom-button-antd w"
              >
                Bắt đầu học ngay
              </Button>
            </div>
