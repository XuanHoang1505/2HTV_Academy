...
const HomePage = () => {
  const [text] = useTypewriter({
    words: [
      "2HTV Academy - Website Bán Khóa học Tốt Nhất Hiện Nay",
  ...
  const renderColoredText = (text) => {
    if (text.includes("2HTV Academy")) {
      return text.split("2HTV Academy").map((part, index) => (
        <span key={index}>
          {part}
          {index === 0 && (
            <span className="text-primary-400 font-[700]">2HTV Academy</span>
          )}
        </span>
      ));
    }
        ...
        <div className="container grid grid-cols-2 gap-3 h-full items-center">
          <div className="col-span-1">
            ...
            <p className="text-sm text-gray-500 mt-5 text-justify leading-relaxed">
              ...
              <strong className="text-primary-400"> 2HTV Academy</strong>, chúng
          ...
          <div className="col-span-1 h-full flex items-center justify-center">
            <div className="relative w-full max-w-md lg:max-w-lg">
              <img
                src={
                  "https://res.cloudinary.com/dopxef4b6/image/upload/v1765962022/banner-home_kk2w1l.png"
                }
      ...
      <section className="py-20 bg-secondary">
        <div className="container">
          <h3 className="text-4xl font-bold text-center mb-16 text-white">
            Học viên nói gì về{" "}
            <span className="text-primary-300">2HTV Academy</span>
          </h3>
