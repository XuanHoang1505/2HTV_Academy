  ...
  const achievements = [
    {
      ...
      description:
        "2HTV Academy được thành lập vào năm 2025 với mục đích mang giáo dục chất lượng cao đến mọi người.",
    },
    {
      title: "Sứ Mệnh",
      description:
        ...
        <div className="container">
          <div className="max-w-2xl mx-auto text-center">
            <h1 className="text-5xl font-bold text-white mb-6">
              Về <span className="text-primary-300">2HTV Academy</span>
            </h1>
            <p className="text-lg text-gray-300 mb-8">
              Chúng tôi tin rằng giáo dục là chìa khóa để mở ra những cơ hội
              mới. 2HTV Academy được tạo ra để giúp bạn đạt được tiềm năng tối
              đa của mình.
            </p>
            <Button
              variant="contained"
      ...
      <section className="py-20 bg-gray-50">
        <div className="container">
          <h2 className="text-4xl font-bold text-center mb-16 text-gray-600">
            Tại Sao Chọn <strong className="text-primary">2HTV Academy </strong>
            ?
          </h2>
      ...
      <section className="py-20 bg-secondary">
        <div className="container text-center">
          ...
          <p className="text-lg text-gray-300 mb-10 max-w-2xl mx-auto">
            ...
            <strong className="text-primary-300">2HTV Academy</strong> để phát
