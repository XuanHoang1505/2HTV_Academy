  ...
  const contactInfo = [
    {
      icon: MailOutlined,
      label: "Email",
      value: "support@2htvacademy.vn",
      link: "mailto:support@2htvacademy.vn",
    },
    {
      icon: PhoneOutlined,
      label: "Hotline",
      ...
      <section className="contact-hero bg-secondary py-20">
        <div className="container">
          <div className="max-w-2xl mx-auto text-center">
            <h1 className="text-5xl font-bold text-primary-300 mb-6">
                  ...
                  return (
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-gray-800 text-base font-bold group-hover:text-primary">
                          {info.value}
                        </p>
                      </div>
                    </a>
